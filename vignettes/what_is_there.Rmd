...
connection is then given to `readLines()`. The lines read are assumed to be full
file paths. Backslashes are converted to slashes. By default, all paths are 
sorted. 

```{r}
# Helper function
read_example <- function(x) kwb.fakin::read_paths(kwb.fakin::extdata_file(x))

...
It is quite impressive how more and more people at our research institute
[Kompetenzzentrum Wasser Berlin](http://komptenz-wasser.de) began to use
the programming language R to support their data-related work.
As a result, if we are currently counting more than one thousand R scripts in 
...
over R script files and the functions defined within these files.

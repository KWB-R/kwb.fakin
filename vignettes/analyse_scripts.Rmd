...
function `get_names_of_used_packages`:
...
packages <- kwb.fakin::get_names_of_used_packages(root_dir)

# Print the script names
kwb.utils::catLines(packages)
```
...
file_info_scripts <- kwb.fakin::get_recursive_file_info(root_dir, "[.]R$")

# Show the structure of the result
str(file_info_scripts)
```

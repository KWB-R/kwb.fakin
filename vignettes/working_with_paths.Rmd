...
By default only the first two levels of folders or files are shown. You can
increase the folder level by setting the `max_depth` argument:

```{r}
kwb.fakin::plot_path_network(paths, max_depth = 4, fontSize = 16)
```

...
function `kwb.pathdict::startsWithParts()` to filter for paths starting with a
...
path_parts[kwb.pathdict::startsWithParts(path_parts, start_parts)]
```
...
folders[kwb.pathdict::startsWithParts(folders, start_parts), ]
folders[kwb.pathdict::startsWithParts(folders, c(start_parts, "input")), ]
```
...
length you may use the function `kwb.pathdict::sortedImportance`:
